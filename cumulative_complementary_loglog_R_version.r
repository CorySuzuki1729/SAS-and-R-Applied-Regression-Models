...
data=health_survey, link="cloglog")
summary(fitted_model)

#extracting AICC and BIC for fitted log-log model
p=8
n=32
...
#checking model fit
intercept_only_mod = clm(health~1, data=health_survey,
link="cloglog")
...
model_pred = predict(fitted_model, type="prob",
