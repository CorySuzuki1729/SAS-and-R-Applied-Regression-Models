...
proc glimmix method=Laplace;
    class family individual relation(ref='D');
    model depression=relation qol_score visit/solution
...
data prediction;
    input family individual relation$ qol_score visit;
    cards;
    25 1 M 3.5 3
    ;
...
proc glimmix method=Laplace;
    ...
    random intercept/subject=family type=un;
    covtest/wald;
    output out=outdata pred(ilink)=p_probdepr;
run;
